//////////////////////////////////////////////////////////////
// GameJava_Joystick.js
//
// GameJava_Joystick creates a movable joystick (via GUITexture) that 
...
static private var joysticks : GameJava_Joystick[];					// A static collection of all joysticks
...
{	
	if (!enumeratedJoysticks)
	{
		...
		joysticks = FindObjectsOfType(GameJava_Joystick) as GameJava_Joystick[];
	...
	else
	{
		for(var i : int = 0;i < count; i++)
		{
			...
			if (shouldLatchFinger && (lastFingerId == -1 || lastFingerId != touch.fingerId))
			{
				...
				for (var j : GameJava_Joystick in joysticks)
				{
					if (j != this)
