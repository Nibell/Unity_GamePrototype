//////////////////////////////////////////////////////////////
// GameCSharp_Joystick.cs
//
// GameCSharp_Joystick creates a movable joystick (via GUITexture) that 
...
public class GameCSharp_Joystick : MonoBehaviour 
{
	...
	static private GameCSharp_Joystick[] joysticks;				// A static collection of all joysticks
	...
	private Vector3 newVal;
	private Vector3 guipixel;
	...
	{	
		if (!enumeratedJoysticks)
		{
			...
			joysticks = FindObjectsOfType(typeof(GameCSharp_Joystick)) as GameCSharp_Joystick[];
		...
		else
		{
			for(int i = 0;i < count; i++)
			{
				...
				if (shouldLatchFinger && (lastFingerId == -1 || lastFingerId != touch.fingerId))
				{
					...
					foreach(GameCSharp_Joystick j in joysticks)
					{
						if (j != this)
