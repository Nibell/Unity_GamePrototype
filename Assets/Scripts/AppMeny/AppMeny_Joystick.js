...
// AppMeny_Joystick.js
//
// AppMeny_Joystick creates a movable joystick (via GUITexture) that 
...
static private var joysticks : AppMeny_Joystick[];           // A static collection of all joysticks
...
{    
 if (!enumeratedJoysticks)
 {
     ...
     joysticks = FindObjectsOfType(AppMeny_Joystick) as AppMeny_Joystick[];
 ...
 else
 {
     for(var i : int = 0;i < count; i++)
     {
         ...
         if (shouldLatchFinger && (lastFingerId == -1 || lastFingerId != touch.fingerId))
         {
             ...
             for (var j : AppMeny_Joystick in joysticks)
             {
                 if (j != this)
